...
class YOLOHead(nn.Module):
    ...
    def __init__(self, in_dim: int, num_classes: int, anchors_per_scale: int = 3):
        ...
        # For single class detection, we still need objectness and class
        ...
        # For single class segmentation, we need only 2 channels (background and object)
        self.seg_head = nn.Sequential(
            ...
            nn.LeakyReLU(0.1),
            nn.Conv2d(in_dim // 2, 2, kernel_size=1)  # 2 channels: background and object
        )
